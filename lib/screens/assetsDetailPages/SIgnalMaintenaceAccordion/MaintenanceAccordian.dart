      ...
      child: Row(
        ...
        children: [
          SizedBox(
            ...
            height: 40.h,
            child: Center(
              child: UiHelper.card_details(
                text: widget.maintenanceList[0]['maintenance'].length != 0
                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        UiHelper.card_details(
                          text: "Start Time",
                          color: Appcolors.secondary,
                        ),
                        SizedBox(height: 6.h),
                        UiHelper.card_details_time(
                          text:
                              widget.maintenanceList[0]['maintenance'].length !=
                                      0
